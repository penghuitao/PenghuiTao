...
<p>Next, when we consider the last measurement on day <strong>n</strong> and are unable to predict the first measurement on day n+1, we include both dayvar and beepvar in the estimation.</p>
