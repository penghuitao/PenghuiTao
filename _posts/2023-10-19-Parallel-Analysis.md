...
<img src="{{ '/assets/img/20240123/Parallel_Analysis.png' | prepend: site.baseurl }}" id="about-img" style="width: 50%; max-width: 800px;">
...
<br>Hayton, J. C., Allen, D. G., & Scarpello, V. (2004). Factor Retention Decisions in Exploratory Factor Analysis: a Tutorial on Parallel Analysis. <i>Organizational Research Methods, 7</i>(2), 191–205. <a href="https://doi.org/10.1177/1094428104263675">https://doi.org/10.1177/1094428104263675</a>
<br>O’connor, B. P. (2000). SPSS and SAS programs for determining the number of components using parallel analysis and Velicer’s MAP test. <i>Behavior Research Methods Instruments &Amp Computers, 32</i>(3), 396–402. <a href="https://doi.org/10.3758/bf03200807">https://doi.org/10.3758/bf03200807</a>
